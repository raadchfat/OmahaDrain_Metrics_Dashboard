...
import { Database, Calendar, DollarSign, User, MapPin, FileText } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">View your SoldLineitems table structure and sample data</p>
        </div>
        <button
            ...
            <table className="min-w-full divide-y divide-gray-200 text-xs">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sampleData.slice(0, 20).map((row, index) => (
                  <tr key={index} className={`hover:bg-gray-50 ${(Number(row.Price) || 0) >= 10000 ? 'bg-green-50' : ''}`}>
